...
\subsubsection{R2.1 -- Nota Média Mediana por Raça/Cor}

A Figura~\ref{fig:r21} apresenta a mediana da nota média para cada categoria de raça/cor. A linha tracejada indica a mediana global da amostra (532,0). Observa-se que candidatos autodeclarados \textbf{Brancos} apresentam a maior mediana, enquanto \textbf{Pretos} e \textbf{Pardos} estão abaixo da mediana global, caracterizando um gradiente racial consistente.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{r21}
    \caption{Nota média mediana por raça/cor (R2.1)}
    \label{fig:r21}
\end{figure}

\subsubsection{R2.2 -- Mediana por Área e Raça/Cor (Heatmap)}

A Figura~\ref{fig:r22} apresenta um heatmap cruzando área de conhecimento e raça/cor. O gradiente de cor revela que candidatos \textbf{Brancos} e \textbf{Amarelos} têm medianas mais altas em todas as áreas, enquanto \textbf{Pretos} e \textbf{Pardos} concentram-se nas cores mais escuras (medianas menores). O padrão é consistente entre áreas, com Redação apresentando as maiores medianas para todos os grupos.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{r22}
    \caption{Mediana por área e raça/cor — heatmap (R2.2)}
    \label{fig:r22}
\end{figure}
