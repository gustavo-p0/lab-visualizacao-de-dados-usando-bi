...
A Figura~\ref{fig:r23} apresenta a dispersão entre Matemática e Redação, as duas disciplinas mais distintas do ENEM. A correlação de Spearman é de 0,53, a mais baixa entre pares de disciplinas objetivas e também em relação à Redação. A nuvem de pontos mostra alta variabilidade: um mesmo desempenho em Matemática pode estar associado a notas muito diferentes em Redação.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{r23}
    \caption{Matemática vs. Redação com ρ de Spearman (R2.3)}
    \label{fig:r23}
\end{figure}

\subsubsection{R2.4 -- Dispersão: Matemática vs. Ciências da Natureza}

A Figura~\ref{fig:r24} mostra a correlação mais forte do ENEM: Matemática $\times$ Ciências da Natureza (0,61 no geral; 0,73 na privada vs. 0,49 na pública). A diferença na inclinação entre os dois segmentos é visualmente clara: na rede privada, a nuvem é mais alongada, indicando maior consistência.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{r24}
    \caption{Matemática vs. CN com ρ de Spearman (R2.4)}
    \label{fig:r24}
\end{figure}
