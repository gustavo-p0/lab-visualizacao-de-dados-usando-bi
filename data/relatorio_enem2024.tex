...
\subsubsection{R2.2 -- Diferença na Correlação: Privada vs. Pública}

A Figura~\ref{fig:r22} mostra a diferença na correlação entre escolas privadas e públicas. Valores positivos (vermelho) indicam correlação mais forte na rede privada. Escolas privadas apresentam correlações substancialmente mais altas, especialmente entre Matemática e Ciências da Natureza (diferença de +0,25) e entre Matemática e Ciências Humanas (+0,19). Isso sugere que o ensino privado produz um perfil de desempenho mais homogêneo — alunos que vão bem em uma disciplina tendem a ir bem em todas.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{r22}
    \caption{Diferença na correlação: privada $-$ pública (R2.2)}
    \label{fig:r22}
\end{figure}

\subsubsection{R2.3 -- Dispersão: Redação vs. Nota Média}

A Figura~\ref{fig:r23} apresenta a dispersão entre Redação e a nota média, segmentada por tipo de escola. A nuvem de pontos revela que, embora a correlação seja moderada (0,45--0,58), candidatos de escolas privadas concentram-se na região superior do gráfico (notas altas em ambos).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{r23}
    \caption{Redação vs. Nota Média por tipo de escola (R2.3)}
    \label{fig:r23}
\end{figure}

\subsubsection{R2.4 -- Dispersão: Matemática vs. Ciências da Natureza}

A Figura~\ref{fig:r24} mostra a forte correlação entre Matemática e Ciências da Natureza (0,61 no geral; 0,73 na rede privada). A diferença entre os dois segmentos é visualmente clara: na rede privada, a nuvem é mais alongada e concentrada, refletindo a maior consistência de desempenho.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{r24}
    \caption{Matemática vs. Ciências da Natureza por tipo de escola (R2.4)}
    \label{fig:r24}
\end{figure}
