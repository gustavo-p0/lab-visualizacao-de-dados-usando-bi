...
A Figura~\ref{fig:r21} apresenta a mediana da nota média para cada categoria de raça/cor. Observa-se que candidatos autodeclarados \textbf{Brancos} apresentam a maior mediana, enquanto \textbf{Pretos} e \textbf{Pardos} apresentam as menores, caracterizando um gradiente racial consistente.
...
\subsubsection{R2.2 -- Mediana por Área e Raça/Cor}

A Figura~\ref{fig:r22} desagrega a mediana por área de conhecimento. O gradiente racial se mantém em todas as áreas, sendo mais pronunciado em Matemática e Redação.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{r22}
    \caption{Mediana por área e raça/cor (R2.2)}
    \label{fig:r22}
\end{figure}
